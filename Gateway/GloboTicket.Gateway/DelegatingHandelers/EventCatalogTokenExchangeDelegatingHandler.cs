...
{
    public class EventCatalogTokenExchangeDelegatingHandler : DelegatingHandler
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly IClientAccessTokenCache _clientAccessTokenCache;


        public EventCatalogTokenExchangeDelegatingHandler(IHttpClientFactory httpClientFactory,
